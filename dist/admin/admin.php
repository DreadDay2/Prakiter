...
<body class="bg-gray-800 justify-center items-center flex flex-col size-full overflow-x-hidden">
    ...
    <main class="w-[95vw] h-auto p-[30px] bg-gray-700 text-white flex flex-col items-center justify-center md:max-xl:flex">
        <section class="md:w-[47.5vw] w-[67.5vw] flex flex-col items-center justify-center mb-[3vh]">
            <h2 class="font-bold md:text-2xl text-[19px] md:mb-[1vh] mb-[3vh] text-center">Witaj w panelu administracyjnym!</h2>
            <?php
            ...
            <?php
                ...
                echo '</div>';
            ?>
            <a href="contentEdit.php">
                <button class="outline-3 outline-solid outline-offset-2 font-bold p-[6px] w-[30vw] md:w-[15vw] mb-[3vh] text-emerald-400 outline-white hover:bg-gray-800 hover:outline-emerald-400 hover:text-white">EDYCJA ZAWARTOŚCI STRONY</button>
            </a>
            <a href="manageUsers.php">
                <button class="outline-3 outline-solid outline-offset-2 font-bold p-[6px] w-[30vw] md:w-[15vw] mb-[3vh] text-emerald-400 outline-white hover:bg-gray-800 hover:outline-emerald-400 hover:text-white">ZARZĄDZANIE UŻYTKOWNIKAMI</button>
            </a>
            <a href="adminTracks.php">
                <button class="outline-3 outline-solid outline-offset-2 font-bold p-[6px] w-[30vw] md:w-[15vw] mb-[3vh] text-emerald-400 outline-white hover:bg-gray-800 hover:outline-emerald-400 hover:text-white">ZARZĄDZANIE MUZYKĄ</button>
            </a>
            <a href="statistics.php">
                <button class="outline-3 outline-solid outline-offset-2 font-bold p-[6px] w-[30vw] md:w-[15vw] text-emerald-400 outline-white hover:bg-gray-800 hover:outline-emerald-400 hover:text-white">STATYSTKI STRONY</button>
            </a>
        </section>
    </main>
